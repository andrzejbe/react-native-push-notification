...
let iOSBackgroundNotification = null;

if (Platform.OS === "ios") {
  AppState.addEventListener("change", function(new_state) {
    if (new_state === "active" && iOSBackgroundNotification !== null) {
      iOSBackgroundNotification();
      iOSBackgroundNotification = null;
    }
  });
}
  ...
  if (this.onNotification !== false) {
    if (Platform.OS === "ios") {
      ...
      if (AppState.currentState !== "background") {
        ...
        iOSBackgroundNotification = triggerNotificaton;
      }
    } else {
